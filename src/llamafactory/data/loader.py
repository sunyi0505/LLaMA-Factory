    ...
    with training_args.main_process_first(desc="pre-process dataset", local=(not data_args.data_shared_file_system)):
        ...
        if model_args.sequence_parallel_size > 1:
            def sequence_parallel_data_processing(examples):
                data = SequenceParallelDataPlugin('pad_sequence')(examples, model_args, tokenizer, data_args)
                return SequenceParallelDataPlugin('sp_split')(data, model_args, tokenizer, data_args)
